...
public class VerifyFeedbackSubmitedSuccessfully extends BaseTest {
	...
	public void testVerifyFeedbackSubmitedSuccessfully() throws Exception {
		...
		assertTrue(driver.findElement(By.cssSelector("BODY")).getText()
				.matches("^[\\s\\S]*Give feedback to the publisher[\\s\\S]*$"));
		driver.findElement(By.xpath("(//input[@name='subject'])[2]")).clear();
		driver.findElement(By.xpath("(//input[@name='subject'])[2]")).sendKeys(
				"Feedback");
		driver.findElement(By.xpath("(//textarea[@name='message'])[2]"))
				.clear();
		driver.findElement(By.xpath("(//textarea[@name='message'])[2]"))
				.sendKeys("This video is nice one.");
		...
		assertEquals(
				"Thanks for your valuable feedback. Your feedback has been communicated to the Publisher",
				AlertMsg);
